            ...
            switch (opcion) {
                ...
                case 'Agregar Facultad':
                    ...
                    return rxjs
                        ...
                        .pipe(
                            map(
                                (facultad: Facultad) => { // resp ant OBS
...
function borrarUsuario(respuestaBDD: RespuestaBDD) {
    return rxjs
        .from(inquirer.prompt(preguntaBuscarUsuario))
        .pipe(
            mergeMap( // RESP ANT OBS
...
function buscarUsuario(respuestaBDD: RespuestaBDD) {
    return rxjs
        .from(inquirer.prompt(preguntaBuscarUsuario))
        .pipe(
            mergeMap( // RESP ANT OBS
